...
Run this on the host that runs the Zeek Docker container. It exposes
...
- ZEEK_CONTAINER_NAME (default: 'zeek')
...
CONTAINER_NAME = os.environ.get('ZEEK_CONTAINER_NAME', 'zeek')
...
def main():
    ...
    print(f"zeek health endpoint listening on {BIND}:{PORT}{PATH} (monitoring container '{CONTAINER_NAME}')")
    try:
