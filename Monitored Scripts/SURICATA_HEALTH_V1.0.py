...
Run this on the host that runs the Suricata Docker container. It exposes
...
- SURICATA_CONTAINER_NAME (default: 'suricata')
...
CONTAINER_NAME = os.environ.get('SURICATA_CONTAINER_NAME', 'suricata')
...
def main():
    ...
    print(f"suricata health endpoint listening on {BIND}:{PORT}{PATH} (monitoring container '{CONTAINER_NAME}')")
    try:
